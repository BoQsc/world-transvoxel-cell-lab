...
static func run() -> Dictionary:
	...
	return {
		...
		"scope_status": {
			...
			"TQP-45": "proposed_pending_fast_arrival_edit_responsiveness",
			"TQP-46": "proposed_pending_targeted_collision_residency",
			"TQP-47": "proposed_pending_large_world_render_frame_memory_queues",
			"TQP-48": "proposed_pending_low_power_profiles",
			"TQP-49": "proposed_pending_complex_adaptive_soak_recovery",
			"TQP-50": "proposed_gate_open",
		},
		"audit_status": "TQP43_QUALIFIED_TQP44_NEXT_GATE_E_OPEN",
