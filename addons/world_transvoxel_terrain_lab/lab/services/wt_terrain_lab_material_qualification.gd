...
static func run() -> Dictionary:
	...
	return {
		...
		"scope_status": {
			...
			"TQP-25": "qualified_reference_visual_quality_corpus",
		},
		"qualified_scope": [
			...
			"TQP-25 accepted four-fixture Windows reference visual-quality corpus",
		],
		"explicitly_unqualified_scope": [
			"production texture assets",
			"visual behavior outside the accepted TQP-25 corpus",
