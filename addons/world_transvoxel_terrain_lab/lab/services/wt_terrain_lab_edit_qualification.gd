...
static func run() -> Dictionary:
	...
	return {
		...
		"scope_status": {
			...
			"TQP-14": "qualified",
			"TQP-17": "qualified",
			"TQP-47": "implemented_pending_fragmentation_collision_and_cost",
		},
		"qualified_scope": [
		...
		"explicitly_unqualified_scope": [
			...
			"TQP-47 fragmentation, collision, and production cost",
		],
...
static func _specify_explosions() -> Dictionary:
	...
	var result := _result("TQP-47", _probe_points().size() + 3, failures)
