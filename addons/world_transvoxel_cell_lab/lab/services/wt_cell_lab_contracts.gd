...
const LAB_CORRECTNESS_CLAIM := "native_transvoxel_terrain_probe_qualification_not_run_v8"
const QUALIFIED_LAB_CORRECTNESS_CLAIM := "release_qualified_transvoxel_terrain_authority_probe_v7"
const FAILED_LAB_CORRECTNESS_CLAIM := "transvoxel_terrain_probe_qualification_failed_v8"
