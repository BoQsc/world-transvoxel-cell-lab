...
single human-readable roadmap. Program revision 23 contains TQP-01 through
TQP-64 in ground-up execution order:

- TQP-01 through TQP-33 are qualified only for their declared bounded scopes;
- TQP-28 through TQP-33 retain the deterministic native field, complex LOD0
  ...
  oracles; TQP-34 through TQP-45 remain proposed;
...
The next milestone is TQP-34, Adversarial, Randomized, And Minimized Repro Corpus.
