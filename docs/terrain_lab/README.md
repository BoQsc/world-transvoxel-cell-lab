...
single human-readable roadmap. Program revision 22 contains TQP-01 through
TQP-64 in ground-up execution order:

- TQP-01 through TQP-32 are qualified only for their declared bounded scopes;
- TQP-28 through TQP-32 retain the deterministic native field, complex LOD0
  corpus, bounded adaptive selector, native transition-assembly matrix, and
  finite-world boundary/enclosure policy; TQP-33 through TQP-45 remain proposed;
...
The next milestone is TQP-33, Independent Geometry And Topology Oracles.
