...
single human-readable roadmap. Program revision 24 contains TQP-01 through
TQP-64 in ground-up execution order:

- TQP-01 through TQP-34 are qualified only for their declared bounded scopes;
- TQP-28 through TQP-34 retain the deterministic native field, complex LOD0
  ...
  oracles plus seeded adversarial replay and minimization; TQP-35 through
...
The next milestone is TQP-35, Dynamic LOD Publication And Temporal Stability.
