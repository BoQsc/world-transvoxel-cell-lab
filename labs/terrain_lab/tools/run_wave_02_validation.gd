...
func _run() -> void:
	...
	var report := {
		"schema": "world_transvoxel.terrain_lab.wave_02_first_batch_qualification.v1",
	...
	if not failures.is_empty():
		_fail("Wave 02 first batch failed: " + str(failures))
		return
	print("WT_TQP_WAVE_02_FIRST_BATCH_PASS")
	quit(0)
...
func _fail(message: String) -> void:
	push_error("WT_TQP_WAVE_02_FIRST_BATCH_FAIL: " + message)
	quit(1)
